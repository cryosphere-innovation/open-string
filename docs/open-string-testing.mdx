...
- [x] Alligator clips
- [x] **4.7 kΩ pull-up resistor** (required — see callout below)
...
3. Connect the string to the Arduino with alligator clips: red to 3.3V, black to GND, and white to your data GPIO. Note: the One-Wire protocol requires the data line to be pulled to the supply voltage. 

<Alert variant="warning" className="my-6">
  <AlertTitle>Pull-up resistor required</AlertTitle>
  <AlertDescription>
